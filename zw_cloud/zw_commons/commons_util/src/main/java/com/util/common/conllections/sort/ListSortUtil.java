...
public class ListSortUtil {
    ...
    public static Object forceGetFieldValue(Object obj, String fieldName) throws Exception {
        Field field = getClassField(obj.getClass(), fieldName);
        Object object = null;
    ...
    public static void main(String[] args) {
        // 排序
        List<Object> holdDatas = new ArrayList<>();
        String[] sort = {"profitDirectionSort"};
        boolean[] arr = {true};
        sort(holdDatas, sort, arr);
    }
